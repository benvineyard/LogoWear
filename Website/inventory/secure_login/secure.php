...
/****** Installation ******/
$cfgIndexpage = '/logowear/lvfr/index.php';
...
$admEmail = 'benvineyard@etronixx.us';
...
$cfgServerPassword = '1willmakeupheerf00';                  // MySQL password

$cfgDbDatabase = 'logowear';        // MySQL database name containing phpSecurePages table
